...
class ExperimentResult:
    def __init__(self, problem_name, system_id, system_name, trial, solution, total_exec_time, conf_matrix, extra_stats, predictions,
                 parameter=None, timeout=None, program_size=None):
    ...
    def __str__(self):
        return f'{self.problem_name}__{self.system_name}__{self.system_id}__{self.parameter} :: {self.total_exec_time:.2f}s :: {self.accuracy}'
